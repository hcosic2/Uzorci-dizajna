...
public class Vozilo {
    ...
    public List<Vozaci> listaVozaca = new ArrayList<>();
    VoziloStanje stanje; 
    ...
    public void kontrola(){
        this.stanje.kontrola(this);
    }
    
    public void kvar(){
        this.stanje.kvar(this);
    }
    
    public void parking(){
        this.stanje.parking(this);
    }
    
    public void prazniSmece(){
        this.stanje.prazniSmece(this);
    }
    
    public void prikupljaOtpad(){
        this.stanje.prikupljaOtpad(this);
    }
